...
MODEL_PATH=/mnt/69_store/lsq/SWE-bench-agent/storage/sft_outputs/sft_step_fillv4_r2e_0_850-filtered-14B-btsz128-lr1e-5-4ep/global_step_760/huggingface
...
export EXPERIMENT_NAME=sft_step_fillv4_r2e_0_850-filtered-14B-btsz128-lr1e-5-4ep-DAPO-cprw${compression_reward_weight}-mcr${max_compression_rate}-fmp${formaterr_penalty}


#j4nc7ygm
# WANDB_RESUME=allow WANDB_RUN_ID=6f7043ue 
# WANDB_RESUME=allow WANDB_RUN_ID=m4qi4mcj 
CUDA_VISIBLE_DEVICES=4,5,6,7 time "${PYTHON_BIN}" -m rllm.trainer.verl.train_agent_ppo \
    ...
    data.shuffle=False \
    data.reverse_order=${REVERSE_ORDER} \
