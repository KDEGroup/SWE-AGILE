...
compression_reward_weight=0.0
max_compression_rate=0.0
formaterr_penalty=-0.2

MODEL_PATH=/mnt/69_store/tmp/SWE-bench-agent/storage/sft_outputs/sft_step_fillv4_r2e_0_850-filtered-8B-2ep/global_step_1520/huggingface
...
export EXPERIMENT_NAME=sft_step_fillv4_r2e_0_850-filtered-8B-2ep-DAPO-wocpr-fmp${formaterr_penalty}

# Wandb的 resume是从最后的step继续，但是训练保存的ckpt的不是最后的step
