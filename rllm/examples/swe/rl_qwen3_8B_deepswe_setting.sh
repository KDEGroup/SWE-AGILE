...
formaterr_penalty=-0.15

MODEL_PATH=/mnt/69_store/lsq/SWE-bench-agent/storage/sft_outputs/sft_step_fillv4_r2e_0_850-filtered-8B-btsz64-4ep/global_step_1520/huggingface
...
export EXPERIMENT_NAME=sft_step_fillv4_r2e_0_850-filtered-8B-btsz64-4ep-DEEPSWE-cprw${compression_reward_weight}-mcr${max_compression_rate}-fmp${formaterr_penalty}-lr${lr}

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m rllm.trainer.verl.train_agent_ppo \
