...
class Step:
    ...
    content: str = ""  # content does not include the reasoning and action.
    reasoning: str = ""
    action: Any = None
    action_text: str = ""  # raw action text before parsing, used for repeat detection
    model_response: str = ""
