...
Absolute path to file or directory. The repository path will be specified in the task instructions.
...
Allowed values: [`view`, `create`, `str_replace`, `insert`]
  (2) path (string, required): Absolute path to file or directory. The repository path will be specified in the task instructions.
...
SWEAGENT_USER_PROMPT = """I have uploaded a python code repository.
...
Can you help me implement the necessary changes to the repository to fix the <github_issue>?
I have already taken care of all changes to any of the test files described in the <github_issue>. This means you DON'T have to modify the testing logic or any of the tests in any way! Your task is to make changes to non-test files in the repository to ensure the <github_issue> is resolved.
